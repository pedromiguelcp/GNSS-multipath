...
file.fileRoute      = ['C:\Users\Pedro\Documents\phd\git\GNSS-multipath\Receiver0\sample data\',file.fileName,'.dat']; % Change the route of the raw IF data 
file.skip        	= 5000;   	
...
solu.iniPos	= [22.31439029684325/180 * pi, 114.2063643133900/180 * pi, 12.849];
